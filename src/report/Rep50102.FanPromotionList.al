    ...
    requestpage
    {
        layout
        {
            area(content)
            {
                group(Options)
                {
                    field(Age12orLess; Age12orLess) { ApplicationArea = Basic, Suite; Caption = 'Age 12 or less'; }
                    field(Age13to18; Age13to18) { ApplicationArea = Basic, Suite; Caption = 'Age 13 to 18'; }
                    field(Age19to34; Age19to34) { ApplicationArea = Basic, Suite; Caption = 'Age 19 to 34'; }
                    field(Age35to50; Age35to50) { ApplicationArea = Basic, Suite; Caption = 'Age 34 to 50'; }
                    field(AgeOver50; AgeOver50) { ApplicationArea = Basic, Suite; Caption = 'Age over 50'; }
                    field(Male; Male) { ApplicationArea = Basic, Suite; Caption = 'Male'; }
                    field(Female; Female) { ApplicationArea = Basic, Suite; Caption = 'Female'; }
                }
            }
        }
    }
